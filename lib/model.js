...
function applyModelConfig(ModelClass, config) {
    var k;
    for (k in config) {
            ...
            if (!this._localStorage) {
                if (!this._localStorageBackend) {
                    if (this.jwtLocalStorage && typeof localStorage !== 'undefined') {
                        ...
                        this._localStorageBackend = new local_storage_1.NullStorageBackend();
                    }
                }
                this._localStorage = new local_storage_1.LocalStorage(this.jwtLocalStorage, this._localStorageBackend);
            }
    ...
    JSORMBase.prototype.assignAttributes = function (attrs) {
        ...
        for (var key in attrs) {
            ...
            if (this.klass.camelizeKeys) {
                attributeName = inflected_1.camelize(key, false);
            }
